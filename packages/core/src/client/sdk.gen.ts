...
import type { HealthControllerGetStatusData, LinkCanvasTemplateInstanceData, LinkCanvasTemplateInstanceResponse, GetThemesData, GetThemesResponse, CreateThemeData, CreateThemeResponse, DeleteThemeData, GetThemeData, GetThemeResponse, UpdateThemeData, UpdateThemeResponse, GetLinkSetsData, GetLinkSetsResponse, CreateLinkSetData, CreateLinkSetResponse, DeleteLinkSetData, GetLinkSetData, GetLinkSetResponse, UpdateLinkSetData, UpdateLinkSetResponse, GetCanvasTemplateData, GetCanvasTemplateResponse, CreateCanvasTemplateData, CreateCanvasTemplateResponse, RenderCanvasTemplateData, RenderCanvasTemplateResponse, GetCredentialIssuerProfilesData, GetCredentialIssuerProfilesResponse, CreateCredentialIssuerProfileData, CreateCredentialIssuerProfileResponse, DeleteCredentialIssuerProfileData, DeleteCredentialIssuerProfileResponse, GetCredentialIssuerProfileData, GetCredentialIssuerProfileResponse, GetCredentialData, IssueCredentialData, IssueCredentialResponse2, VerifyCredentialData, VerifyCredentialResponse2, GetDidsData, GetDidsResponse, CreateDidData, CreateDidResponse, DeleteDidData, DeleteDidResponse, GetDidData, GetDidResponse, CreateDppData, CreateDppResponse, DeleteDppData, GetDppData, GetDppResponse, GetManyExternalResolversData, CreateExternalResolverData, DeleteExternalResolverData, GetExternalResolverData, UpdateExternalResolverData, CreateOrganizationData, CreateOrganizationResponse, DeleteOrganizationData, GetOrganizationData, GetOrganizationResponse, UpdateOrganizationData, UpdateOrganizationResponse } from './types.gen';
