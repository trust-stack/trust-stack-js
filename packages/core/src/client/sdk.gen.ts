 ...
 * Get all calendar entries for an asset
 */
export const getCalendarEntries = <ThrowOnError extends boolean = false>(options: Options<GetCalendarEntriesData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetCalendarEntriesResponse, unknown, ThrowOnError>({
        ...options,
 ...
 * Create a new calendar entry for an asset
 */
export const createCalendarEntry = <ThrowOnError extends boolean = false>(options: Options<CreateCalendarEntryData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateCalendarEntryResponse, unknown, ThrowOnError>({
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
 ...
 * Get a specific calendar entry for an asset
 */
export const getCalendarEntryById = <ThrowOnError extends boolean = false>(options: Options<GetCalendarEntryByIdData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetCalendarEntryByIdResponse, unknown, ThrowOnError>({
        ...options,
 ...
 */
export const deleteCanvasTemplate = <ThrowOnError extends boolean = false>(options: Options<DeleteCanvasTemplateData, ThrowOnError>) => {
    return (options?.client ?? client).delete<unknown, unknown, ThrowOnError>({
        ...options,
 ...
 * Update a Canvas Template.
 */
export const updateCanvasTemplate = <ThrowOnError extends boolean = false>(options: Options<UpdateCanvasTemplateData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateCanvasTemplateResponse, unknown, ThrowOnError>({
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
 ...
 * Get many Canvas Templates.
 */
export const getCanvasTemplates = <ThrowOnError extends boolean = false>(options?: Options<GetCanvasTemplatesData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetCanvasTemplatesResponse, unknown, ThrowOnError>({
        ...options,
 ...
 * Set an event schema
 */
export const setEventSchema = <ThrowOnError extends boolean = false>(options: Options<SetEventSchemaData, ThrowOnError>) => {
    return (options?.client ?? client).post<SetEventSchemaResponse, unknown, ThrowOnError>({
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
...
/**
 * Create an event form for an event schema
 */
 ...
 * Get app.
 */
export const getAppFrame = <ThrowOnError extends boolean = false>(options?: Options<GetAppFrameData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetAppFrameResponse, unknown, ThrowOnError>({
        ...options,
...
/**
 * Update app frame.
 * Update the frame of the app.
 */
export const setAppFrame = <ThrowOnError extends boolean = false>(options: Options<SetAppFrameData, ThrowOnError>) => {
    return (options?.client ?? client).put<SetAppFrameResponse, unknown, ThrowOnError>({
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
...
/**
 * Get app routes.
 * Get a paginated list of app routes.
 */
export const getAppRoutes = <ThrowOnError extends boolean = false>(options?: Options<GetAppRoutesData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetAppRoutesResponse, unknown, ThrowOnError>({
        ...options,
...
/**
 * Update app route.
 * Create or update an app route.
 */
export const setAppRoute = <ThrowOnError extends boolean = false>(options: Options<SetAppRouteData, ThrowOnError>) => {
    return (options?.client ?? client).put<SetAppRouteResponse, unknown, ThrowOnError>({
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
...
/**
 * Get app route by path.
 * Get an app route by its path.
 */
export const getAppRouteByPath = <ThrowOnError extends boolean = false>(options: Options<GetAppRouteByPathData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetAppRouteByPathResponse, unknown, ThrowOnError>({
        ...options,
...
export const getOrganizations = <ThrowOnError extends boolean = false>(options?: Options<GetOrganizationsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetOrganizationsResponse, unknown, ThrowOnError>({
        ...options,
        url: '/organizations'
    });
};
