 ...
 * Set the link set for a link anchor
 */
export const setLinkAnchor = <ThrowOnError extends boolean = false>(options: Options<SetLinkAnchorData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, unknown, ThrowOnError>({
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * Get a link anchor
 */
export const getLinkAnchor = <ThrowOnError extends boolean = false>(options: Options<GetLinkAnchorData, ThrowOnError>) => {
    return (options?.client ?? client).get<unknown, unknown, ThrowOnError>({
        ...options,
        url: '/link-anchors/{id}'
    });
