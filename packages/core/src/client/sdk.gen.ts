 ...
 * Consume a Bio Lock
 */
export const consumeBioLock = <ThrowOnError extends boolean = false>(options: Options<ConsumeBioLockData, ThrowOnError>) => {
    return (options?.client ?? client).post<ConsumeBioLockResponse, unknown, ThrowOnError>({
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
