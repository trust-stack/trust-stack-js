...
export type ResolveUrlResponse = {
     ...
     */
    resolutionType?: 'redirect' | 'linkset';
};
...
export type MintLinkAnchorData = {
    body?: never;
    path?: never;
    query?: never;
...
export type MintLinkAnchorResponses = {
    201: unknown;
};

export type MintManyLinkAnchorsData = {
    body: MintManyRequest;
    path?: never;
    query?: never;
    url: '/link-anchors/mint-many';
};

export type MintManyLinkAnchorsResponses = {
    201: unknown;
};
...
export type GetManyLinkAnchorsData = {
    body?: never;
    path?: never;
    query?: never;
    url: '/link-anchors';
